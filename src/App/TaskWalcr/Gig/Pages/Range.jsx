    ...
    return (
        <div style={{ marginBottom: "40px" }} className={style.Container}>
            ...
            <div style={{ marginTop: '50px' }}>
                ...
                <p style={{ fontSize: "16px" }}>
                    Your delivery zone is set from your residential location. Search location to change delivery zone.
                </p>
                ...
                <div>
                    ...
                    <p style={{ fontSize: "13px" }}>
                        <span style={{ color: "orange" }}> * </span> Maximum range is based on the selected means of transportation
                    </p>
                </div>
                ...
                <div>
                    <RadioGroup onChange={setValue2} value={value2}>
                        <div className={style.RadioContainer} style={{border:'none'}}>
                            <div>
                                ...
                                <p style={{ fontSize: "14px" }}>Name is private and will be use for your private listing..</p>
                            </div>
                            <Radio size='lg' colorScheme='orange' value='1'></Radio>
                        </div>

                        <div className={style.RadioContainer} style={{border:'none', marginTop:'-10px'}}>
                            <div>
                    ...
                    <Slider aria-label='slider-ex-2' colorScheme='orange' defaultValue={30}>
                        <SliderTrack>
                            <SliderFilledTrack />
                        </SliderTrack>
                        <SliderThumb />
