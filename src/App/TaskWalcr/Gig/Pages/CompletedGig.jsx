...
const CompletedGig = () => {
  return (
    <div style={{padding:"15px"}}>
        ...
        <span>
        Choose price range from the lowest gig price to highest price range from the lowest gig price to highest price range from
        </span>

        <Button variant="default" style={{border:"1px solid #000", borderRadius:"10px", padding:"20px"}}>
                View on Marketplace
        </Button>
    </div>
    </div>
