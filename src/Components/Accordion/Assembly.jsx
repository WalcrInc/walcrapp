...
import {
    InputGroup, Input, FormLabel, RangeSlider,
    RangeSliderTrack,
...
const Assembly = () => {
    return (
        <div style={{ marginBottom: "40px" }} className={style.Container}>
            ...
            <div>
                <div style={{ width: "100%", height: "100px", border: "1px solid #000", borderRadius: "10px", padding: "10px", marginTop: "25px", marginBottom:"15px" }}>
                    <span>
                ...
                <RangeSlider aria-label={['min', 'max']} defaultValue={[10, 30]} colorScheme='orange'>
                    <RangeSliderTrack>
                        <RangeSliderFilledTrack />
                    </RangeSliderTrack>
