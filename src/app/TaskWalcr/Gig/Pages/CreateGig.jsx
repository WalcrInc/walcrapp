...
const CreateGig = () => {
  ...
  return (
    <div style={{ marginBottom: "40px" }} className={style.Container}>
      <div>
        <h1 style={{ fontSize: "25px", fontWeight: "700" }}>Create Gig</h1>
        <p>
          Publish a Gig to the Walcr marketplace <br />
          <span>Add more gigs based on your skillset</span>
        </p>
      </div>
      ...
      <div>
        ...
        <div>
          <h1>Search tags for (Assembling)</h1>
          <p>Name is private and will be use for your private listing..</p>
          <InputGroup
            boxShadow={" 0px 0px 0px 1px #CDD1DC"}
            borderRadius={"8px"}
          ...
          <span>5 tags maximum Use letters and numbers only.</span>
        </div>
